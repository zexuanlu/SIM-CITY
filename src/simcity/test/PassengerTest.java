...
public class PassengerTest extends TestCase{
	...
	public void testOneNormalCustomerScenario()
	{
		...
		busstop.busstop = true; //test hack to make it so that the mock busstop returns true 
	...
	public void testTwoNormalPassengerSituation(){
		//normative scenario, bus not at bus stop so passenger messages busstop then gets on
		...
		assertTrue("passenger needs to react to the new Event",passenger.pickAndExecuteAnAction());
		assertFalse("passenger has no actions",passenger.pickAndExecuteAnAction()); 
		assertTrue("passenger should ask busstop to go to bus", busstop.log.containsString("Passenger at Stop"));
