...
public class BankHostTest extends TestCase {
	...
	public void testOneCustomerOneTeller(){
		...
		assertFalse("The end of day boolean should be false. It isn't", bh.endOfDay);
	...
	public void testEndOfDay(){
		...
		assertTrue("BankHost should have logged \"Received msgEndOfDay\" but didn't. His log reads instead: " 
				+ bh.log.getLastLoggedEvent().toString(), bh.log.containsString("Received msgEndOfDay"));
	...
	public void testTwoCustomersOneTellerEndOfDay(){
		assertEquals("Bank Host should contain 0 Tellers. It doesn't.", bh.tellers.size(), 0);
		assertFalse("Bank Host's atDesk should be false. It isn't", bh.atDesk);
		assertFalse("The end of day boolean should be false. It isn't", bh.endOfDay);
