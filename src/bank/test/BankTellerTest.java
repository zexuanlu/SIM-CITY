...
public class BankTellerTest extends TestCase {
	...
	public void testOne(){
		...
		assertEquals("The amount of the task should be $100. It isn't", bt.tasks.get(1).amount, 100);
		assertEquals("The account number of the task should be 324324. It isn't", bt.tasks.get(1).accountNumber, 324324);
	}
}
