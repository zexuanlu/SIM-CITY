...
import restaurant3.Restaurant3AbstractWaiter.MyCustomer;
...
public class Restaurant3SDWaiterRole extends Restaurant3AbstractWaiter implements Restaurant3Waiter{
	...
	//CONSTRUCTOR ************************************
	public Restaurant3SDWaiterRole(String name, PersonAgent pa) {
			super(pa);
			this.name = name;
	...
	public void setRevolvingStand(Restaurant3RevolvingStand r){
		revStand = r;
	}
