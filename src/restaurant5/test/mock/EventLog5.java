 ...
 *
 */
public class EventLog5 {

	/**
	 * This is the backing data store for the list of events.
	 */
	private LinkedList<LoggedEvent5> events = new LinkedList<LoggedEvent5>();
	 ...
	 * @param e
	 */
	public void add(LoggedEvent5 e) {
		events.add(e);
	}
	 ...
	 *         string
	 */
	public LoggedEvent5 getFirstEventWhichContainsString(String message) {
		for (LoggedEvent5 e : events) {
			if (e.getMessage().contains(message)) {
				return e;
			}
	 ...
	 */
	public LoggedEvent5 getLastLoggedEvent() {
